...
export default function Page() {
  ...
  const fullFaceMasksCategory = data.categoryList[0].children.find(category => category.name === 'Protective Coveralls');
  console.log("category wise from ear protection =====>", fullFaceMasksCategory)
  const category_id= 9;
const pageName = 'protective-coveralls'
  return (
    <>
